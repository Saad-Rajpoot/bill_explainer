...
class ChargeCardWidget extends StatelessWidget {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                            UrduFormatter.pkr(charge.amount,
                        ...
                        if (charge.status == ChargeStatus.high)
                          Text(
                            lp.translate('statusHigh'),
                            style: const TextStyle(
  ...
  static Color _statusColor(ChargeStatus s) {
    return switch (s) {
      ...
      ChargeStatus.high => AppColors.secondary,
    };
  }
}
